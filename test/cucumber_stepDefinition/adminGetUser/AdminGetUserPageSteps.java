package cucumber_stepDefinition.adminGetUser;
...
public class AdminGetUserPageSteps {
	...
	public void admin_is_on_the_Admin_Get_User_page() throws Throwable {
	...
	@Then("^Admin sess page header as \"([^\"]*)\"$")
	public void admin_sess_page_header_as(String expected) throws Throwable {
	...
	public void admin_enters_invalid_data_to_a_field() throws Throwable {
		...
		lastNameEl.clear();
		lastNameEl.sendKeys("test123123-rt456");   
	}
	...
	public void review_delete_button_should_be_displayed() throws Throwable {
