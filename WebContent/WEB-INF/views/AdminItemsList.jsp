					...
					<div class="row">
						<form action="${context}/admin/UpdateItem" method="post" class="form-horizontal" id="items-list">
							<div class="form-group">
			   					...
			   					<div class="col-sm-9">
			    					<input type="text" class="form-control" name="name" id="itemName" placeholder="Item Name" value="${item.itemName}" maxlength="20" required title="Please enter upto 20 characters">
			    				</div>
			  				</div>
						  	<div class="form-group">
						   		<label for="itemPrice" class="col-sm-3 control-label">Price</label>
						   		<div class="col-sm-9">
						    		<input type="text" class="form-control" name="price" id="itemPrice" placeholder="Item Price"value="${item.itemPrice}" maxlength="20" required title="Please enter upto 20 numbers">
						    	</div>
						  	</div>
							<div class="form-group">
							   	<label for="itemDescription" class="col-sm-3 control-label">Item Description</label>
							    <div class="col-sm-9">
							    	<textarea rows="3" class="form-control" name="description" id="itemDescription" placeholder="Item Description" maxlength="500" required title="Please enter upto 500 characters">${item.itemDescription}</textarea>
							    </div>
							 </div>
							 <div class="form-group">
							    <label for="itemImage" class="col-sm-3 control-label">Item Image</label>
							    <div class="col-sm-9">
							    	<input type="text" class="form-control" name="image" id="itemImage" placeholder="Item Image" value="${item.image}" maxlength="20" required title="Please enter upto 20 characters">
							    </div>
							 </div>
							 <div class="form-group">
				    			...
				    			<div class="col-sm-9">
							 		<label class="radio-inline">
				    					<input type="radio" name="active" id="active" value="1" ${item.active == 1 ? 'checked' : ''} required>Active
									</label>
				  					<label class="radio-inline">
										<input type="radio" name="active" id="not active" value="0" ${item.active == '0' ? 'checked' : ''} required>Not Active
				  					</label>
								</div>
							</div>
							 <div class="form-group">
							    ...
							    <div class="col-sm-9">
							    	<input type="text" class="form-control" name="category" id="Category" placeholder="Category" value="${item.category}" maxlength="20" required title="Please enter upto 20 charcaters">
							    </div>
							 </div>
